"""Creating a child class called Admin from the Users class that inherits the attributes of the parent class and also has its own specific attribute and method."""
...
"""Creating an instance of the child class Admin and then calling the show_privileges() method to list out the privileges of the instance Administrator."""
Administrator = Admin("Azeez", "Yekinni", "30", "Ogun", "Male")
